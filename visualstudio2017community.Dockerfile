...
RUN choco install --confirm visualstudio2017community --package-parameters "--allWorkloads --includeRecommended --includeOptional --passive --locale en-US" || \skip-reboot.bat
